 ...
 *   on the output mode.
 *******
 * $Id: generator.c,v 1.111 2008/03/26 15:56:13 thuffir Exp $
 */
    ...
    char *srcRoot)
{
    ...
    case TEST:
        ...
        break;
    case XMLDOCBOOK:
        RB_XMLDB_Generate_BeginSection( dest_doc, depth, name, header, srcRoot );
        break;
    case HTML:
 ...
 */
{
    ...
    case TEST:
        ...
        break;
    case XMLDOCBOOK:
        RB_XMLDB_Generate_Header_Start( dest_doc, cur_header, srcRoot );
        break;
    case HTML:
 ...
 */
{
    ...
    for ( i_header = part->headers; i_header; i_header = i_header->next )
    {
        RB_Say( "generating documentation for header \"%s\"\n", SAY_INFO,
                i_header->name );
        document_file = RB_Generate_Header_Start( document_file, i_header, document->srcroot->name );
